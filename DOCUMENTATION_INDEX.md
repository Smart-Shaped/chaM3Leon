...
**Kafka?** → [ARCHITECTURE.md](docs/ARCHITECTURE.md#apache-kafka---il-messaggero)

**Cassandra?** → [ARCHITECTURE.md](docs/ARCHITECTURE.md#apache-cassandra---il-magazzino)

**Machine Learning?** → [ML Runner](https://github.com/Smart-Shaped/PyChaM3Leon)
