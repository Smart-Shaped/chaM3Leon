...
class BlackboxExceptionTest {
  ...
  void testBlackBoxExceptionThrown() {
    assertThrows(
        ...
        () -> {
          throw new BlackboxException("Test com.smartshaped.chameleon.batch.exception");
        });
  }
  ...
  void testExceptionThrownWithCause() {
    ...
    BlackboxException exception =
        assertThrows(
            BlackboxException.class,
            () -> {
              throw new BlackboxException("Test com.smartshaped.chameleon.batch.exception", cause);
            });
