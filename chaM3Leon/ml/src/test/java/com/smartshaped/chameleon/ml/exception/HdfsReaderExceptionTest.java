...
class HdfsReaderExceptionTest {
  ...
  void testHDFSReaderExceptionThrown() {
    assertThrows(
        ...
        () -> {
          throw new HdfsReaderException("Test com.smartshaped.chameleon.batch.exception");
        });
  }
  ...
  void testExceptionThrownWithCause() {
    ...
    HdfsReaderException exception =
        assertThrows(
            HdfsReaderException.class,
            () -> {
              throw new HdfsReaderException("Test com.smartshaped.chameleon.batch.exception", cause);
            });
