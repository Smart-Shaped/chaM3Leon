...
class PipelineExceptionTest {
  ...
  void testPipelineExceptionThrown() {
    assertThrows(
        ...
        () -> {
          throw new PipelineException("Test com.smartshaped.chameleon.batch.exception");
        });
  }
  ...
  void testExceptionThrownWithCause() {
    ...
    PipelineException exception =
        assertThrows(
            PipelineException.class,
            () -> {
              throw new PipelineException("Test com.smartshaped.chameleon.batch.exception", cause);
            });
