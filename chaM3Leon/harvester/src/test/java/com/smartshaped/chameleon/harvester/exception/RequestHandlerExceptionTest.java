...
class RequestHandlerExceptionTest {
  ...
  void testRequestHandlerExceptionThrown() {
    assertThrows(
        ...
        () -> {
          throw new RequestHandlerException("Test com.smartshaped.chameleon.batch.exception");
        });
  }
  ...
  void testExceptionThrownWithCause() {
    ...
    RequestHandlerException exception =
        assertThrows(
            RequestHandlerException.class,
            () -> {
              throw new RequestHandlerException("Test com.smartshaped.chameleon.batch.exception", cause);
            });
