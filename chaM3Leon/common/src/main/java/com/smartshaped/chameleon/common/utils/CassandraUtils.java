...
public class CassandraUtils {
   ...
   * <p>This class is thread safe.
   *
   * @param configurationUtils the configuration com.smartshaped.chameleon.batch.utils to be used to create the Cassandra session
   ...
   *
   * @param configurationUtils the configuration com.smartshaped.chameleon.batch.utils to use
