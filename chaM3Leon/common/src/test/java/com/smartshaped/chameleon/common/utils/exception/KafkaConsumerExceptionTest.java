...
class KafkaConsumerExceptionTest {
  ...
  void testKafkaConsumerExceptionThrown() {
    assertThrows(
        ...
        () -> {
          throw new KafkaConsumerException("Test com.smartshaped.chameleon.batch.exception");
        });
  }
  ...
  void testExceptionThrownWithCause() {
    ...
    KafkaConsumerException exception =
        assertThrows(
            KafkaConsumerException.class,
            () -> {
              throw new KafkaConsumerException("Test com.smartshaped.chameleon.batch.exception", cause);
            });
