...
public class HarvesterSaver {
     ...
     *
     * <p>
     * This method writes the given Dataset<Row> to the specified path in Parquet format
     * using the append mode. This allows new data to be appended to the existing data at
