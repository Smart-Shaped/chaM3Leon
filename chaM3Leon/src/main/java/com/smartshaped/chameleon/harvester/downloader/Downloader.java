...
public abstract class Downloader<T> {
    ...
    protected Downloader() throws ConfigurationException {
        ...
        try {
            ...
            throw new ConfigurationException("Failed to retrieve query parameters for class: " + className, e);
        }
        ...
        try {
            ...
            throw new ConfigurationException("Failed to retrieve URL parameters for class: " + className, e);
        }
     ...
     */
    public abstract T download(List<String> reqParams, Request req) throws DownloaderException, ConfigurationException;
