...
public abstract class BatchLayer {
  ...
  /**
   * Starts the BatchLayer process by reading data from Kafka, preprocessing it, saving it to HDFS,
   * and executing batch updates if a BatchUpdater is configured.
   *
   ...
   *   <li>If a BatchUpdater is configured, it initiates the batch update process.
