...
class BlackBoxTest {
    ...
    void testDeleteHdfsFolderDeleteFailed() throws ConfigurationException, IOException {
        ...
        try (MockedConstruction<Configuration> mockedStatic = mockConstruction(Configuration.class);
             MockedStatic<FileSystem> mockedStaticFileSystem = mockStatic(FileSystem.class);
             MockedConstruction<Path> mockedStaticPath = mockConstruction(Path.class)) {

            mockedStaticFileSystem.when(() -> FileSystem.get(any(Configuration.class))).thenReturn(fileSystem);
    ...
    void testRunCommandSuccess() throws ConfigurationException, IOException {
        ...
        try (MockedConstruction<InputStreamReader> mockedStatic = mockConstruction(InputStreamReader.class);
             MockedConstruction<BufferedReader> mockedStaticBufferedReader = mockConstruction(BufferedReader.class)) {
    ...
    @Test
    void testRunCommandFailureExitCode() throws ConfigurationException, IOException, InterruptedException {
    ...
    @Test
    void testRunCommandInterruptedException() throws ConfigurationException, IOException, InterruptedException {
